...
Template.moneyPage.helpers({
    networthEach() {
        return DevTest.find( { networthitemName: {$exists: true}}, {sort: {createdAt: -1}}); },
    fireplanEach() {
        return DevTest.find( { fireplanitemName: {$exists: true}}, {sort: {createdAt: -1}}); },
    earningsrateEach() {
        return DevTest.find( { earningsrateitemName: {$exists: true}}, {sort: {createdAt: -1}}); },
    spendingrateEach() {
        return DevTest.find( { spendingrateitemName: {$exists: true}}, {sort: {createdAt: -1}}); },
    assetsEach() {
        return DevTest.find( { assetsitemName: {$exists: true}}, {sort: {createdAt: -1}}); },
    borrowdebtEach() {
        return DevTest.find( { borrowdebtitemName: {$exists: true}}, {sort: {createdAt: -1}}); },
    savingsrateEach() {
        return DevTest.find( { savingsrateitemName: {$exists: true}}, {sort: {createdAt: -1}}); },
    runrateEach() {
        return DevTest.find( { runrateitemName: {$exists: true}}, {sort: {createdAt: -1}}); },
    debttoequityEach() {
        return DevTest.find( { debttoequityitemName: {$exists: true}}, {sort: {createdAt: -1}}); },
    budgetEach() {
        return DevTest.find( { budgetitemName: {$exists: true}}, {sort: {createdAt: -1}}); },
    improveMoneypageEach() {
        return DevTest.find( { improveMoneypageitemName: {$exists: true}}, {sort: {createdAt: -1}}); },
});
