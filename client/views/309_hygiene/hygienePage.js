...
Template.hygienePage.helpers({
    showerEach() {
        return DevTest.find( { showeritemName: {$exists: true}}, {sort: {createdAt: -1}}); },
    bathEach() {
        return DevTest.find( { bathitemName: {$exists: true}}, {sort: {createdAt: -1}}); },
    shaveEach() {
        return DevTest.find( { shaveitemName: {$exists: true}}, {sort: {createdAt: -1}}); },
    nailsEach() {
        return DevTest.find( { nailsitemName: {$exists: true}}, {sort: {createdAt: -1}}); },
    hairEach() {
        return DevTest.find( { hairitemName: {$exists: true}}, {sort: {createdAt: -1}}); },
    hairconditionEach() {
        return DevTest.find( { hairconditionitemName: {$exists: true}}, {sort: {createdAt: -1}}); },
    brushedteethEach() {
        return DevTest.find( { brushedteethitemName: {$exists: true}}, {sort: {createdAt: -1}}); },
    flossedEach() {
        return DevTest.find( { flosseditemName: {$exists: true}}, {sort: {createdAt: -1}}); },
    deoderantEach() {
        return DevTest.find( { deoderantitemName: {$exists: true}}, {sort: {createdAt: -1}}); },
    dressedlogEach() {
        return DevTest.find( { dressedlogitemName: {$exists: true}}, {sort: {createdAt: -1}}); },
    improveHygienepageEach() {
        return DevTest.find( { improveHygienepageitemName: {$exists: true}}, {sort: {createdAt: -1}}); },
