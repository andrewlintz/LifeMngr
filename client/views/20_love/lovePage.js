...
Template.lovePage.helpers({
    howSodoingEach() {
        return DevTest.find( { howSodoingitemName: {$exists: true}}, {sort: {createdAt: -1}}); },
    soLikesEach() {
        return DevTest.find( { soLikesitemName: {$exists: true}}, {sort: {createdAt: -1}}); },
    soDislikesEach() {
        return DevTest.find( { soDislikesitemName: {$exists: true}}, {sort: {createdAt: -1}}); },
    soWantsEach() {
        return DevTest.find( { soWantsitemName: {$exists: true}}, {sort: {createdAt: -1}}); },
    sogiftideasEach() {
        return DevTest.find( { sogiftideasitemName: {$exists: true}}, {sort: {createdAt: -1}}); },
    soArguementlogEach() {
        return DevTest.find( { soArguementlogitemName: {$exists: true}}, {sort: {createdAt: -1}}); },
    soPeriodlogEach() {
        return DevTest.find( { soPeriodlogitemName: {$exists: true}}, {sort: {createdAt: -1}}); },
    lovehistEach() {
        return DevTest.find( { lovehistitemName: {$exists: true}}, {sort: {createdAt: -1}}); },
    dreamSoEach() {
        return DevTest.find( { dreamSoitemName: {$exists: true}}, {sort: {createdAt: -1}}); },
    sexhistEach() {
        return DevTest.find( { sexhistitemName: {$exists: true}}, {sort: {createdAt: -1}}); },
    improveLovepageEach() {
        return DevTest.find( { improveLovepageitemName: {$exists: true}}, {sort: {createdAt: -1}}); },
});
