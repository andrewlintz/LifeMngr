...
Template.healthPage.helpers({
    biostatsEach() {
        return DevTest.find( { biostatsitemName: {$exists: true}}, {sort: {createdAt: -1}}); },
    familyMedhistEach() {
        return DevTest.find( { familyMedhistitemName: {$exists: true}}, {sort: {createdAt: -1}}); },
    allergiesEach() {
        return DevTest.find( { allergiesitemName: {$exists: true}}, {sort: {createdAt: -1}}); },
    symptomsEach() {
        return DevTest.find( { symptomsitemName: {$exists: true}}, {sort: {createdAt: -1}}); },
    bodyachelogEach() {
        return DevTest.find( { bodyachelogitemName: {$exists: true}}, {sort: {createdAt: -1}}); },
    sicklogEach() {
        return DevTest.find( { sicklogitemName: {$exists: true}}, {sort: {createdAt: -1}}); },
    medhistoryEach() {
        return DevTest.find( { medhistoryitemName: {$exists: true}}, {sort: {createdAt: -1}}); },
    medicineEach() {
        return DevTest.find( { medicineitemName: {$exists: true}}, {sort: {createdAt: -1}}); },
    dentallogEach() {
        return DevTest.find( { dentallogitemName: {$exists: true}}, {sort: {createdAt: -1}}); },
    dentistryhistEach() {
        return DevTest.find( { dentistryhistitemName: {$exists: true}}, {sort: {createdAt: -1}}); },
    visionhistEach() {
        return DevTest.find( { visionhistitemName: {$exists: true}}, {sort: {createdAt: -1}}); },
    pooplogEach() {
        return DevTest.find( { pooplogitemName: {$exists: true}}, {sort: {createdAt: -1}}); },
    peelogEach() {
        return DevTest.find( { peelogitemName: {$exists: true}}, {sort: {createdAt: -1}}); },
    improveHealthpageEach() {
        return DevTest.find( { improveHealthpageitemName: {$exists: true}}, {sort: {createdAt: -1}}); },
});
