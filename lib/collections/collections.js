...
// Start of jot Methods Block  //
  ...
  'jotitemName.insert'(jotitemName) {
  ...
  'jotitemName.remove'(documentId) {
    ...
    const jot = Agenda.findOne(documentId);
  ...
  'updateListItem': function(documentId, jotItem){
    ...
    Agenda.update({ _id: documentId }, {$set: { jotitemName : jotItem, title : jotItem, description : jotItem }});
  },
