...
// Start of opinion Methods Block //
  ...
  'opinionitemName.remove'(documentId) {
    ...
    const opinion = DevTest.findOne(documentId);
  ...
  'updateopinionItem': function(documentId, opinionItem){
    ...
    DevTest.update({ _id: documentId }, {$set: { opinionitemName : opinionItem, title : opinionItem, description : opinionItem }});
  },
...
// Start of workspacetightines Methods Block //
  ...
  'workspacetightinesitemName.remove'(documentId) {
    ...
    const workspacetightines = DevTest.findOne(documentId);
  ...
  'updateworkspacetightinesItem': function(documentId, workspacetightinesItem){
    ...
    DevTest.update({ _id: documentId }, {$set: { workspacetightinesitemName : workspacetightinesItem, title : workspacetightinesItem, description : workspacetightinesItem }});
  },
...
// Start of pplconstact Methods Block //
  ...
  'pplconstactitemName.remove'(documentId) {
    ...
    const pplconstact = DevTest.findOne(documentId);
  ...
  'updatepplconstactItem': function(documentId, pplconstactItem){
    ...
    DevTest.update({ _id: documentId }, {$set: { pplconstactitemName : pplconstactItem, title : pplconstactItem, description : pplconstactItem }});
  },
